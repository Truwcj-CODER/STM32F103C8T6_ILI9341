...
int main(void)
{
  ...
  ILI9341_Init();
   ...
   ILI9341_DrawText("TOPIC:", FONT4, 125, 30, BLUE, RED);
   ILI9341_DrawText("SETUP", FONT4, 265, 210, BLUE, RED);
   ILI9341_DrawText("SET TEMPERATURE, HUMIDITY", FONT4, 20, 60, BLUE, RED);
   ILI9341_DrawText("AC MOTOR SPEED CONTROL", FONT4, 25, 90, BLUE, RED);
   ILI9341_DrawText("TEMPERATURE: ", FONT4, 20, 135, BLUE, RED);
   ILI9341_DrawText("HUMIDITY: ", FONT4, 20, 170, BLUE, RED);
   ILI9341_DrawText("ENGINE STATUS: ", FONT4, 20, 210, BLUE, RED);
   ILI9341_DrawHollowRectangleCoord(170, 130, 280, 155, DARKCYAN);
   ILI9341_DrawHollowRectangleCoord(170, 170, 280, 195, DARKCYAN);
   ILI9341_DrawFilledCircle(200, 215, 12, GREEN);
   ILI9341_DrawFilledCircle(230, 215, 12, BLUE);
   HAL_Delay(5000);
